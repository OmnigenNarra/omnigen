...
{
    template<>
    struct DesertClusterSubData<EDesertBlockSubtype::DuneSand> : DesertClusterSubDataBase
    {
    ...
    template<>
    class DesertSubCluster<EDesertBlockSubtype::DuneSand> : public DesertSubClusterBase
    {
    public:
