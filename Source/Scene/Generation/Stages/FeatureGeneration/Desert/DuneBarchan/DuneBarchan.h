...
{
    template<>
    struct DesertClusterSubData<EDesertBlockSubtype::DuneBarchan> : DesertClusterSubDataBase
    {
    public:
    ...
    template<>
    class DesertSubCluster<EDesertBlockSubtype::DuneBarchan> : public DesertSubClusterBase
    {
    public:
