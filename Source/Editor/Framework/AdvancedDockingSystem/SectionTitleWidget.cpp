	...
	_activeTab(false)
{
	...
	l->setSpacing(0);
    auto* titleWidget = content->titleWidget();
...
void SectionTitleWidget::setActiveTab(bool active)
{
	...
	{
		_activeTab = active;
		setStyleSheet(_activeTab ? "QFrame {color:#f2f2f2; background: #383838; margin: 0px 0px 0px 3px}" : "QFrame {color:#666666; background: #383838; margin: 0px 0px 0px 3px}");
		style()->unpolish(this);
		style()->polish(this);
		update();
